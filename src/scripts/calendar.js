...
for (let day = 1; day <= daysInMonth; day++) {
    ...
    const event = events.find(event => {
      ...
      const eventStartDate = new Date(event.startDate).toISOString().split('T')[0]; // Extrait la date au format YYYY-MM-DD
